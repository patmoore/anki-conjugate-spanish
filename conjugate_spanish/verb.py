...
ir_conjugation_overrides = ConjugationOverride()
...
ir_conjugation_overrides.override_tense_stem(present_tense, six.u('v'))
ir_conjugation_overrides.override_tense_ending(present_tense, Standard_Conjugation_Endings[ar_verb][present_tense])
...
ir_conjugation_overrides.override_tense_stem(past_tense, six.u('fu'))
ir_conjugation_overrides.override_tense_ending(past_tense, six.u('e'), third_person_singular)
ir_conjugation_overrides.override_tense_ending(past_tense, six.u('eron'), third_person_plural)

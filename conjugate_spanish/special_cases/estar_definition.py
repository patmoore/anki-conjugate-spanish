...
_conjugation_overrides = ConjugationOverride(parents=[u'oy', u'e_and_o'])
...
Verb_Dictionary_add(u'estar', conjugation_overrides=_conjugation_overrides, definition="to be")

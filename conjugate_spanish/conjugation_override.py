...
__all__ = ['ConjugationOverride', 'Standard_Overrides', 'Dependent_Standard_Overrides', 'UniversalAccentFix',
           '_replace_last_letter_of_stem']
...
def make_std_override(inf_match=None, parents=None, documentation=None, examples=None, key=None, auto_match=None,
                      manual_overrides=None, irregular_nature=None):
    conjugation_override = ConjugationOverride(inf_match, parents, documentation, examples, key, auto_match,
                                               manual_overrides, irregular_nature)
...
def make_dep_override(inf_match=None, parents=None, documentation=None, examples=None, key=None, auto_match=None,
                      manual_overrides=None, irregular_nature=None):
    conjugation_override = ConjugationOverride(inf_match, parents, documentation, examples, key, auto_match,
                                               manual_overrides, irregular_nature)
...
class ConjugationOverride(object):
                    ...
                    for tenseStr, conjugation_override in overrides.items():
                        if conjugation_override is not None:
                            if tenseStr == 'present_except_nosvos':
                                ...
                                self._overrides(Tense.imperative_positive, conjugation_override, applies,
    ...
    def override_past_stem_changers(self, overrides, documentation=None):
        ...
        """
        self.override_tense_stem(tenses=Tense.past_tense, overrides=overrides,
                                 persons=Person.Past_Tense_Stem_Changing_Persons(), documentation=documentation)
    ...
    def __repr__(self):
        return "ConjugationOverride(inf_match={0}, parents={1}, documentation={2}, examples={3}, key={4}, auto_match={5}, manual_overrides={6}, irregular_nature={7})".format(
            self.inf_match, self.parents, self.documentation, self.examples, self.key, self.auto_match,
            self.manual_overrides, self.irregular_nature)
...
class Radical_Stem_Conjugation_Override(ConjugationOverride):
    def __init__(self, inf_stem_vowel, present_stem_vowels=None, beginning_word_vowels=None,
                 ...
                 inf_match=None, parents=None, documentation=None, examples=None, auto_match=None,
                 manual_overrides=None,
                 ):
        ...
        super(Radical_Stem_Conjugation_Override, self).__init__(inf_match, parents, documentation, examples, key,
                                                                auto_match, manual_overrides,
        ...
        def __make_radical_call(vowels_from, vowels_to, beginning_word_vowels_to=None, beginning_word_vowels_from=None):
            ...
            regex = re_compile('^(.*?)(' + Vowels.re_any_string(vowels_from) + '|' + Vowels.re_any_string(
                vowels_to) + ')?(' + Vowels.consonants + '*(qu|gu)?)$')
            if beginning_word_vowels_from is not None:
                # huelo needs to be checked for 'hue' before looking for 'ue'
                regexes = [re_compile('^()(' + Vowels.re_any_string(
                    beginning_word_vowels_from) + ')(' + Vowels.consonants + '*(qu|gu)?)$'), regex]
            else:
                regexes = [regex]
            ...
            def __radical_stem_change(self, conjugation_notes, **kwargs):
                ...
                for regex in regexes:
                    ...
                    if match_ is None:
                        ...
                        self.__raise(
                            msg=key + ':vowels being looked for were not the last ones. ' + conjugation_notes.core_verb,
                            **kwargs)
        ...
        infinitive_to_past_tense = __make_radical_call(inf_stem_vowel, past_stem_vowels,
                                                       beginning_word_vowels_to=beginning_word_vowels)
        if self.present_stem_vowels is not None:
            infinitive_to_present_tense = __make_radical_call(inf_stem_vowel, self.present_stem_vowels,
                                                              beginning_word_vowels_to=beginning_word_vowels)
            # used to change present subjective 1st/2nd person plural
            present_tense_to_past_tense = __make_radical_call(self.present_stem_vowels, self.past_stem_vowels,
                                                              beginning_word_vowels_from=beginning_word_vowels)
            present_tense_to_infinitive = __make_radical_call(self.present_stem_vowels, self.inf_stem_vowel,
                                                              beginning_word_vowels_from=beginning_word_vowels)
            ...
            self.first_person_conjugation_override.override_tense_stem(Tense.present_tense, infinitive_to_present_tense,
            ...
            self.most_present_tense.override_tense_stem(Tense.present_tense, infinitive_to_present_tense,
                                                        [Person.second_person_singular, Person.third_person_singular,
            ...
            self.nos_vos_present_subjective_ir = make_std_override(key=key + '_pres_sub_nos_vos_ir',
                                                                   documentation='stem changing ir verbs that actually applied the stem change in the yo-present use the 3rd past tense vowel',
                                                                   examples=['dormir', 'morir']
                                                                   )
            self.nos_vos_present_subjective_ir.override_tense_stem(Tense.present_subjective_tense,
            ...
            self.nos_vos_present_subjective_ar = make_std_override(key=key + '_pres_sub_nos_vos',
                                                                   documentation='stem changing ar,er verbs use the infinitive vowel. ir verbs that do not apply the stem change in the yo-present use the infinitive vowel',
                                                                   examples=['dormir', 'morir']
                                                                   )
            self.nos_vos_present_subjective_ar.override_tense_stem(Tense.present_subjective_tense,
                                                                   present_tense_to_infinitive,
                                                                   [Person.first_person_plural,
                                                                    Person.second_person_plural])
        ...
        self.conjugation_overrides[Infinitive_Ending.ir_verb].extend(
            [self.stem_changing_ir_gerund, self.stem_changing_ir_past])
    ...
    def apply(self, verb):
        ...
        if verb.verb_ending_index == Infinitive_Ending.ir_verb and verb.has_override_applied(
                self.first_person_conjugation_override.key):
    ...
    @classmethod
    def make(cls, inf_stem_vowel, present_stem_vowels=None, past_stem_vowels=None,
             past_stem_persons=Person.third_person(), beginning_word_vowels=None):
        conjugation_override = Radical_Stem_Conjugation_Override(inf_stem_vowel=inf_stem_vowel,
                                                                 present_stem_vowels=present_stem_vowels,
                                                                 past_stem_vowels=past_stem_vowels,
                                                                 beginning_word_vowels=beginning_word_vowels)
        # really should be here -- but we don't have to worry about adding an object to a global
        # before init completes for this program so f*ck it
        #         conjugation_override.add_std()
...
def _universal_accent_correction(self, conjugation_notes, **kwargs):
    ...
    if Vowels.accented_vowel_check.search(conjugation_notes.core_verb) and Vowels.accented_vowel_check.search(
            conjugation_notes.ending):
...
UniversalAccentFix.override_tense_join(Tense.all(), _universal_accent_correction,
                                       documentation="ensure an accented ending overrides an accented stem")
...
Use_Er_Conjugation_In_Past = make_std_override(key='use_er',
                                               documentation='some -ar verbs use -er conjugation in past tense',
                                               examples=['andar', 'estar'])
Use_Er_Conjugation_In_Past.override_tense_ending(Tense.past_tense,
                                                 lambda self, conjugation_notes, **kwargs: conjugation_notes.change(
                                                     ...
                                                     ending=Standard_Conjugation_Endings[Infinitive_Ending.er_verb][
                                                         conjugation_notes.tense][conjugation_notes.person]))
...
def _yendo_(self, conjugation_notes, **kwargs):
    if conjugation_notes.core_verb == '':  # ir
        _check_and_change(conjugation_notes, ending_re=STARTS_WITH_I, ending_beginning_replacement='y',
                          operation=self.key)
    else:
        _check_and_change(conjugation_notes, ENDS_WITH_VOWEL, STARTS_WITH_I, ending_beginning_replacement='y',
                          operation=self.key)
...
def __i2y_past_3rd_i_check(self, conjugation_notes, **kwargs):
    if not _check_and_change(conjugation_notes, ENDS_WITH_VOWEL,
        ...
        _check_and_change(conjugation_notes, ending_re=STARTS_WITH_I, ending_beginning_replacement='',
                          operation=self.key)
...
I2Y_PastTense_CO.override_tense_join(Tense.past_tense, __i2y_past_3rd_i_check, Person.third_person(),
                                     documentation="change i to y or remove i if stem doesn't end in vowel")
...
Accent_All_But_3_PastTense_CO.override_tense_join(Tense.past_tense, _accent_i_check,
                                                  Person.all_except(Person.third_person()),
...
def _i_i_remove(self, conjugation_notes, **kwargs):
    _check_and_change(conjugation_notes, ENDS_WITH_I, STARTS_WITH_I, ending_beginning_replacement='',
                      operation=self.key)
...
Guir_CO.override_tense_stem(Tense.present_tense, lambda self, conjugation_notes,
                                                        **kwargs: conjugation_notes.change(operation=self.key,
                                                                                           irregular_nature=IrregularNature.sound_consistence,
                                                                                           core_verb=_replace_last_letter_of_stem(
                                                                                               conjugation_notes.core_verb,
                                                                                               'u')),
                            Person.first_person_singular)
...
Eir_CO.override_tense_join(Tense.present_tense, _eir_present_tense_most,
                           documentation="replace i (after stem change) with accented í",
                           persons=Person.all_except(Person.first_person_plural))
Eir_CO.override_tense_join(Tense.present_tense, _eir_present_tense_first_plural, documentation="accent on the i",
                           persons=Person.first_person_plural)
Eir_CO.override_tense_join(Tense.present_subjective_tense, _eir_present_sub_tense_first_plural,
                           documentation="remove accent on the i", persons=Person.first_person_plural)
...
for suffix in ['aer', 'eer', 'oír', 'oer']:
    co = make_std_override(inf_match=re_compile(suffix + '$'),
                           ...
                           key=suffix,
                           parents=[Yendo_Gerund_CO, I2Y_PastTense_CO, Accent_All_But_3_PastTense_CO,
                                    Accent_I_PastParticipleAdjective_CO],
...
def _oir_present_tense(self, conjugation_notes, **kwargs):
    _check_and_change(conjugation_notes, ENDS_WITH_VOWEL, STARTS_WITH_E, ending_beginning_replacement='ye',
                      operation=self.key)
...
def _oir_present_nos(self, conjugation_notes, **kwargs):
    _check_and_change(conjugation_notes, ENDS_WITH_VOWEL, STARTS_WITH_I, ending_beginning_replacement='í',
                      operation=self.key)
...
def _ll_n_check(self, conjugation_notes, **kwargs):
    ...
    _check_and_change(conjugation_notes, ENDS_WITH_LL_N, STARTS_WITH_I, ending_beginning_replacement='',
                      operation=self.key)
...
Yes_Iar_CO = make_std_override(inf_match=re_compile('[lfr]iar$'),
     ...
     In listed examples -fiar,-liar,riar verbs were always "iar"',
                               examples=['amplifiar', 'confiar', 'desafiar', 'des-confiar', 'fiar', 'fotografiar',
                                         'porfiar', 'telegrafiar', 'agriar', 'arriar', 'criar', 'enfriar'])
...
Guar_CO = make_std_override(inf_match=re_compile('guar$'),
                            ...
                            examples=['averiguar'],
                            documentation=[
                                'guar verbs need a umlaut/dieresis ü to keep the u sound so we pronounce gu like gw which keeps it consistent with the infinitive sound http://www.spanish411.net/Spanish-Preterite-Tense.asp',
                                "preserves sound in infinitive"],
                            irregular_nature=IrregularNature.sound_consistence)
...
def __go(self, conjugation_notes, **kwargs):
    if conjugation_notes.core_verb[-1:] in Vowels.all:
        conjugation_notes.change(operation='igo', irregular_nature=IrregularNature.standard_irregular,
                                 core_verb=conjugation_notes.core_verb + 'ig')
    elif conjugation_notes.core_verb[-1:] == 'c':
        # hacer, saticificar is example
        # drop c before -go
        conjugation_notes.change(operation='c_go', irregular_nature=IrregularNature.standard_irregular,
                                 core_verb=conjugation_notes.core_verb[:-1] + 'g')
    else:
        conjugation_notes.change(operation=self.key, irregular_nature=IrregularNature.standard_irregular,
                                 core_verb=conjugation_notes.core_verb + 'g')
...
Oy_CO.override_tense_ending(Tense.present_tense,
                            lambda self, conjugation_notes, **kwargs: conjugation_notes.change(operation=self.key,
                                                                                               irregular_nature=IrregularNature.standard_irregular,
                                                                                               ending="oy"),
                            Person.first_person_singular)

Infinitive_Stems_E2D = make_std_override(key='e2d',
                                         documentation="Future Tense/Conditional Tense:Some verbs convert the -er ending infinitive stem to a 'd'",
                                         examples=['tener'])
Infinitive_Stems_E2D.override_tense_stem(Tense.future_cond(),
                                         lambda self, conjugation_notes, **kwargs: conjugation_notes.change(
                                             operation=self.key, irregular_nature=IrregularNature.rare,
                                             core_verb=conjugation_notes.core_verb[:-2] + 'dr'))

Infinitive_Stems_R_Only = make_std_override(key='r_only',
                                            documentation="Future Tense/Conditional Tense:Some verbs remove the vowel in the infinitive ending to a r",
                                            examples=['haber'])
Infinitive_Stems_R_Only.override_tense_stem(Tense.future_cond(),
                                            lambda self, conjugation_notes, **kwargs: conjugation_notes.change(
                                                operation=self.key, irregular_nature=IrregularNature.rare,
                                                core_verb=conjugation_notes.core_verb[:-2] + 'r'))
...
Imperative_Infinitive_Stem_Only.override_tense(Tense.imperative_positive,
                                               ...
                                               conjugation_notes.change(operation=self.key,
                                                                        irregular_nature=IrregularNature.rare,
                                                                        core_verb=conjugation_notes.phrase.stem,
                                                                        ending=''), Person.second_person_singular)
...
Past_Participle_To.override_tense_ending(Tense.past_participle,
                                         lambda self, conjugation_notes, **kwargs: conjugation_notes.change(
                                             operation=self.key, irregular_nature=IrregularNature.rare, ending='to'))
...
def _olver_(self, conjugation_notes, **kwargs):
    _check_and_change(conjugation_notes, ENDS_WITH_OLV,
                      stem_ending_replacement='uel', operation=self.key,
                      irregular_nature=IrregularNature.standard_irregular)
...
def _abrir_(self, conjugation_notes, **kwargs):
    _check_and_change(conjugation_notes, ENDS_WITH_R,
                      stem_ending_replacement='ier', operation=self.key,
                      irregular_nature=IrregularNature.standard_irregular)
...
def _morir_(self, conjugation_notes, **kwargs):
    _check_and_change(conjugation_notes, ENDS_WITH_OR,
                      stem_ending_replacement='uer', operation=self.key,
                      irregular_nature=IrregularNature.standard_irregular)
...
def _cribir_(self, conjugation_notes, **kwargs):
    _check_and_change(conjugation_notes, ENDS_WITH_B,
                      stem_ending_replacement='', operation=self.key,
                      irregular_nature=IrregularNature.standard_irregular)
...
def _ver_(self, conjugation_notes, **kwargs):
    _check_and_change(conjugation_notes,
                      stem_ending_replacement='is', operation=self.key,
                      irregular_nature=IrregularNature.standard_irregular)
...
def _acer_(self, conjugation_notes, **kwargs):
    _check_and_change(conjugation_notes,
                      ...
                      ending_beginning_replacement='echo', operation=self.key,
                      irregular_nature=IrregularNature.standard_irregular)
...
UnaccentPresent_Past_CO = make_std_override(key='unaccent_present_past',
                                            documentation='small verbs have no accent on past and present tense conjugations',
                                            examples=['dar', 'ir'])
...
Third_Person_Only_CO.override_tense(tenses=Tense.all_except(Tense.Person_Agnostic()), overrides=__block_conjugation,
                                    persons=Person.all_except(Person.third_person()),
                                    documentation="third person only verbs don't conjugate for any other person")

Third_Person_Singular_Only_CO = make_std_override(key='3rd_sing_only', examples=['helar'])
Third_Person_Singular_Only_CO.override_tense(tenses=Tense.all_except(Tense.Person_Agnostic()),
                                             overrides=__block_conjugation,
                                             persons=Person.all_except(Person.third_person_singular),
                                             documentation="third person singular only verbs don't conjugate for any other person (weather)")
